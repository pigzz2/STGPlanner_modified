...
namespace preprocess {
    ...
    public:
        ...
        FrontierMap<Viewpoint> frontiers_viewpoints_;
        ViewpointMap<FrontierQueue> viewpoints_attached_frontiers_;
        ViewpointSet candidate_viewpoints_;
        ViewpointSet new_viewpoints_;
